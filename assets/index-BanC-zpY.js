...
1. 觀測狀況：${r}
2. 時間方位：${s}
3. 專業建議：${o}`},FA=({planet:t,calculateRealPosition:e,earthRealPosition:n,onClose:i,showAxialTilt:r,onToggleAxialTilt:s})=>{const[o,a]=de.useState("intro"),[l,c]=de.useState(""),[f,d]=de.useState(!1),[h,m]=de.useState(!1),v=de.useRef(null),[x,p]=Xl.useMemo(()=>{var S;const D=t.description.split("【冷知識】");return[D[0].trim(),(S=D[1])==null?void 0:S.trim()]},[t.description]),u=D=>{let S=Math.atan2(D.y,D.x)*(180/Math.PI);return S<0&&(S+=360),S},g=()=>{if(t.id==="sun"||t.id==="earth")return"";if(t.id==="moon")return"模型幾何計算參考: 月相隨地月日相對位置而變化";const D=e(t.id),S=n,T=u(D),z=u(S);let $=T-z;$<0&&($+=360);const re=t.orbitRadius<2490;let I="";if(re){const W=-S.x,q=-S.y,K=D.x-S.x,N=D.y-S.y;W*N-q*K>0?I="東大距側 (昏星/日落後可見)":I="西大距側 (晨星/日出前可見)"}else Math.abs($-180)<20?I="衝 (Opposition) - 整夜可見，最亮":$<20||$>340?I="合 (Conjunction) - 接近太陽，不可見":I="一般觀測期";return`模型幾何計算參考: 行星位於太陽${I}`},_=()=>t.parentId==="jupiter"?"(對木星赤道)":t.parentId==="saturn"?"(對土星赤道)":"(對黃道)",y=D=>{if(D===0)return"0";const S=D.toString();return S.includes(".")?S.split(".")[1].length<2?D.toFixed(2):S:D.toFixed(2)};de.useEffect(()=>{c(""),d(!1),m(!1),a("intro"),v.current&&(v.current.scrollTop=0)},[t.id]);const C=()=>{m(!0),d(!0);const D=new Date().toLocaleDateString("zh-HK",{year:"numeric",month:"long",day:"numeric"}),S=g();OA(t.name,D,S).then(T=>{c(T),d(!1)})},R=({label:D,value:S,isLast:T=!1,action:z})=>j.jsxs("div",{className:`flex justify-between py-4 mr-5 ml-5 ${T?"":"border-b border-slate-800"}`,children:[j.jsx("span",{className:"text-base font-medium text-slate-400 tracking-wide break-keep pr-3",children:D}),j.jsxs("div",{className:"flex md:flex-wrap-reverse text-right items-center gap-3 ml-auto",children:[z,j.jsx("span",{className:"text-base font-mono font-bold text-slate-300 text-right ml-auto",children:S})]})]}),A=t.id!=="earth"&&t.id!=="sun";return j.jsxs("div",{className:"w-full font-sans h-full relative flex flex-col overflow-hidden",children:[j.jsxs("div",{className:"flex-shrink-0 z-30 bg-slate-950 border-b border-slate-800/50 pt-6 shadow-2xl transition-all duration-300 relative",children:[j.jsxs("div",{className:`flex flex-col gap-5 px-6 ${A?"mb-5":""}`,children:[j.jsxs("button",{onClick:i,className:"flex items-center gap-2 text-slate-400 hover:text-white transition-colors group w-max",children:[j.jsx("div",{className:"flex items-center justify-center rounded-full shadow-md transition-all duration-300",children:j.jsx(lA,{size:20})}),j.jsx("span",{className:"text-base font-bold uppercase tracking-wide",children:"返回"})]}),j.jsxs("div",{children:[j.jsx("h2",{className:"text-xl font-bold text-slate-200 flex items-center gap-3 leading-7",children:j.jsx("span",{children:t.name})}),j.jsx("p",{className:"text-indigo-400 text-base font-bold uppercase tracking-widest mt-1.5",children:t.type==="terrestrial"?"類地行星":t.type==="gas"?"氣態巨行星":t.type==="ice"?"冰巨行星":t.type==="moon"?"衛星":"恆星"})]})]}),A&&j.jsx("div",{className:"w-full h-px bg-slate-800/50"}),A&&j.jsxs("div",{className:"relative flex w-full",children:[j.jsxs("button",{onClick:()=>a("intro"),className:`flex-1 py-3 text-base font-bold tracking-widest uppercase transition-colors duration-300 flex items-center justify-center gap-2 ${o==="intro"?"text-indigo-400":"text-slate-400 hover:text-slate-300"}`,children:[j.jsx(uA,{size:16,className:`transition-opacity duration-300 ${o==="intro"?"opacity-100":"opacity-70"}`}),"簡介"]}),j.jsxs("button",{onClick:()=>a("observation"),className:`flex-1 py-3 text-base font-bold tracking-widest uppercase transition-colors duration-300 flex items-center justify-center gap-2 ${o==="observation"?"text-indigo-400":"text-slate-400 hover:text-slate-300"}`,children:[j.jsx(km,{size:16,className:`transition-opacity duration-300 ${o==="observation"?"opacity-100":"opacity-70"}`}),"觀測指南"]}),j.jsx("div",{className:"absolute bottom-0 h-[2px] bg-indigo-500 transition-all duration-300 ease-out shadow-[0_-1px_6px_rgba(99,102,241,0.5)]",style:{left:o==="intro"?"0%":"50%",width:"50%"}})]}),!A&&j.jsx("div",{className:"pb-5"})]}),j.jsxs("div",{ref:v,className:"flex-1 overflow-y-auto custom-scrollbar px-6 pb-8 pt-6 [scrollbar-gutter:stable] animate-in fade-in slide-in-from-bottom-2 duration-500",children:[o==="intro"&&j.jsxs("div",{className:"space-y-8",children:[j.jsxs("div",{className:"space-y-6",children:[j.jsx("p",{className:"text-slate-300 text-base font-normal leading-6 text-justify whitespace-pre-line",children:x}),p&&j.jsxs("div",{className:"relative overflow-hidden bg-gradient-to-br from-indigo-950/40 to-purple-900/10 border border-indigo-500/30 rounded-xl p-5 shadow-inner",children:[j.jsx("div",{className:"absolute -bottom-4 -right-4 text-indigo-500/5 transform rotate-12 pointer-events-none",children:j.jsx(Fm,{size:100})}),j.jsxs("div",{className:"relative z-10 space-y-2",children:[j.jsxs("h4",{className:"text-base text-indigo-400 font-bold uppercase tracking-widest flex items-center gap-2",children:[j.jsx(Fm,{size:14,className:"text-indigo-400"}),"星際冷知識"]}),j.jsx("p",{className:"text-slate-300 text-base font-normal leading-6 text-justify",children:p})]})]})]}),j.jsx("div",{children:j.jsxs("div",{className:"bg-slate-900/60 backdrop-blur-sm rounded-xl border border-slate-800 overflow-hidden",children:[t.id!=="sun"&&j.jsx(R,{label:"公轉週期",value:t.period===0?"N/A":`${t.period} 年`}),j.jsx(R,{label:"自轉週期",value:t.rotationPeriod}),j.jsx(R,{label:"轉軸傾角",value:`${y(t.axialTilt)}°`,action:t.id!=="sun"&&t.axialTilt>=1?j.jsx("button",{onClick:D=>{D.stopPropagation(),s()},className:`px-3 py-1.5 rounded-lg transition-all duration-300 flex items-center justify-center gap-2 text-xs font-medium border ml-auto -mt-1 -mb-1 ${r?"bg-indigo-600 text-white border-transparent shadow-[0_0_10px_rgba(79,70,229,0.5)]":"bg-slate-800 text-slate-300 border-slate-700 hover:text-indigo-400 hover:border-indigo-500/50"}`,title:r?"隱藏轉軸":"顯示轉軸",children:j.jsx("span",{children:r?"隱藏轉軸":"顯示轉軸"})}):void 0}),t.id!=="sun"&&j.jsx(R,{label:"軌道傾角",value:`${y(t.inclination)}° ${_()}`}),t.volume&&j.jsx(R,{label:"體積",value:t.volume}),t.mass&&j.jsx(R,{label:"質量",value:t.mass}),j.jsx(R,{label:"表面溫度",value:t.temperature}),t.gravity&&j.jsx(R,{label:"表面重力",value:t.gravity}),t.id!=="earth"&&j.jsx(R,{label:"視星等",value:t.magnitude}),t.type!=="moon"&&t.id!=="sun"&&j.jsx(R,{label:"已知衛星數目",value:t.moons,isLast:!0})]})})]}),o==="observation"&&A&&j.jsxs("div",{className:"space-y-8",children:[j.jsx("div",{children:t.observationInfo?j.jsx("p",{className:"text-slate-300 text-base font-normal leading-6 text-justify whitespace-pre-line",children:t.observationInfo}):j.jsx("p",{className:"text-slate-400 italic",children:"暫無詳細觀測資料。"})}),j.jsx("div",{children:h?f?j.jsxs("div",{className:"flex flex-col items-center gap-3 text-slate-300 text-base py-8 justify-center bg-slate-950/50 rounded-xl border border-slate-800/50",children:[j.jsx(xA,{className:"animate-spin text-indigo-400",size:24}),j.jsx("span",{children:"正在分析天體位置與實時數據..."})]}):j.jsxs("div",{className:"text-base text-slate-300 space-y-3 whitespace-pre-wrap leading-6 animate-in fade-in slide-in-from-bottom-2 bg-slate-950/50 p-5 rounded-xl border border-slate-800/60",children:[l,j.jsxs("div",{className:"mt-4 pt-3 border-t border-slate-800/50 text-sm text-slate-400 text-right flex items-center justify-end gap-1.5",children:[j.jsx(RA,{size:14,className:"text-indigo-400"}),j.jsx("span",{children:"Powered by AI (Demo Simulation)"})]})]}):j.jsxs("button",{onClick:C,className:"w-full py-3 bg-indigo-600 hover:bg-indigo-500 text-slate-200 text-base font-medium rounded-lg transition-all flex items-center justify-center gap-2 shadow-lg shadow-indigo-900/20 active:scale-[0.98]",children:[j.jsx(km,{size:18}),"獲取今日香港觀測詳情"]})})]})]})]})},kA=Xl.memo(FA),wu=({p:t,onClick:e})=>{var r;const n=((r=t.name.split("(")[1])==null?void 0:r.replace(")",""))||"",i=t.name.split(" ")[0];return j.jsxs("button",{onClick:()=>e(t.id),className:"group relative flex flex-col justify-center p-3 rounded-lg bg-slate-800/40 hover:bg-slate-700/60 border border-slate-700/50 hover:border-indigo-500/50 transition-all duration-300 overflow-hidden text-left shadow-sm hover:shadow-lg hover:shadow-indigo-900/20",children:[j.jsxs("div",{className:"flex items-center gap-3 relative z-10",children:[j.jsx("div",{className:"w-10 h-10 rounded-full flex-shrink-0 shadow-lg group-hover:scale-110 transition-transform duration-500 border border-white/10",style:{background:`radial-gradient(circle at 30% 30%, ${t.color}, #1a1a1a)`,boxShadow:`0 0 10px ${t.color}40`}}),j.jsxs("div",{className:"flex flex-col min-w-0",children:[j.jsx("span",{className:"text-sm font-bold text-slate-200 group-hover:text-white truncate",children:i}),j.jsx("span",{className:"text-xs font-bold text-slate-400 uppercase tracking-wider group-hover:text-indigo-300 transition-colors truncate",children:n})]})]}),j.jsx("div",{className:"absolute inset-0 bg-gradient-to-br from-indigo-500/0 via-indigo-500/0 to-indigo-500/0 group-hover:from-indigo-500/5 group-hover:to-purple-500/10 transition-all duration-500"})]})},zA=()=>{const[t,e]=de.useState(!0),[n,i]=de.useState(625e-6),[r,s]=de.useState(0),[o,a]=de.useState(0),[l,c]=de.useState(null),[f,d]=de.useState(!0),[h,m]=de.useState(0),[v,x]=de.useState(!1),[p,u]=de.useState(null),[g,_]=de.useState(!1),y=de.useRef(null),C=de.useRef(void 0),R=de.useRef(n),A=de.useRef(t),D=de.useRef(null),S=de.useRef(null),T=de.useRef(null);de.useEffect(()=>{R.current=n},[n]),de.useEffect(()=>{A.current=t},[t]),de.useEffect(()=>{if(l){const ue=$t.find(Te=>Te.id===l)||null;ue&&u(ue),_(!1)}else T.current&&(T.current.scrollTop=0,requestAnimationFrame(()=>{T.current&&(T.current.scrollTop=0)}));x(!1)},[l]),de.useEffect(()=>{const ue=new Date("2000-01-01T12:00:00Z").getTime(),O=(new Date().getTime()-ue)/(1e3*60*60*24);a(O)},[]);const z=de.useCallback((ue,Te)=>{let O=ue;const at=1e-6;for(let be=0;be<5;be++){const Ne=O-Te*Math.sin(O)-ue,Se=1-Te*Math.cos(O);if(O=O-Ne/Se,Math.abs(Ne)<at)break}return O},[]),$=de.useCallback((ue,Te)=>{const O=$t.find(nt=>nt.id===ue);if(O.id==="sun")return{id:O.id,x:0,y:0,z:0,scale:1,angle:0,distanceFromSun:0};const at=O.period*365.25,Ne=2*Math.PI/at*Te,Se=z(Ne,O.eccentricity),ot=O.orbitRadius,He=O.eccentricity,b=ot*Math.sqrt(1-He*He),M=ot*(Math.cos(Se)-He),B=b*Math.sin(Se),ae=O.orbitAngle*Math.PI/180,se=M*Math.cos(ae)-B*Math.sin(ae),le=M*Math.sin(ae)+B*Math.cos(ae),we=Math.atan2(le,se),ge=O.inclination*Math.PI/180,xe=O.orbitRadius*Math.sin(ge)*Math.sin(we);let De=se,Ve=xe,oe=le;return{id:O.id,x:De,y:Ve,z:oe,scale:1,angle:we,distanceFromSun:Math.sqrt(De*De+oe*oe)}},[z]),re=$t.map(ue=>$(ue.id,r)),I=de.useCallback(ue=>{if(C.current!==void 0){const Te=ue-C.current;A.current&&s(O=>O+Te*R.current*.5)}C.current=ue,y.current=requestAnimationFrame(I)},[]);de.useEffect(()=>(y.current=requestAnimationFrame(I),()=>{y.current&&cancelAnimationFrame(y.current)}),[I]);const W=ue=>{c(ue),_(!1)},q=ue=>{c(ue),_(!1)},K=()=>{c(null),m(ue=>ue+1),_(!1)},N=de.useCallback(()=>{x(ue=>!ue)},[]),H=de.useCallback(()=>{c(null)},[]),G=de.useCallback(ue=>{const Te=$(ue,o),O=$t.find(at=>at.id===ue);if(O!=null&&O.parentId){const at=$(O.parentId,o);return{...Te,x:Te.x+at.x,y:Te.y+at.y,z:Te.z+at.z}}return Te},[$,o]),ee=de.useMemo(()=>$("earth",o),[$,o]),ie=de.useMemo(()=>$t.filter(ue=>ue.type==="star"),[]),k=de.useMemo(()=>$t.filter(ue=>["terrestrial","gas","ice"].includes(ue.type)),[]),Z=de.useMemo(()=>$t.filter(ue=>ue.type==="moon"),[]),ce=de.useMemo(()=>l?p?p.name:"Loading...":"選擇天體",[l,p]),_e=de.useMemo(()=>!l||!p?"Default":p.type==="terrestrial"?"類地行星":p.type==="gas"?"氣態巨行星":p.type==="ice"?"冰巨行星":p.type==="moon"?"衛星":"恆星",[l,p]),ve=l?"5.5rem":"3.5rem",Oe=g?"h-[70dvh]":l?"h-[5.5rem]":"h-[3.5rem]",Ie=g?"calc(70dvh + 20px)":`calc(${ve} + 20px)`;return j.jsxs("div",{className:"w-full h-[100dvh] flex flex-col md:flex-row bg-[#020617] overflow-hidden text-slate-100 font-sans relative",children:[j.jsxs("aside",{ref:D,className:`
          flex flex-col
