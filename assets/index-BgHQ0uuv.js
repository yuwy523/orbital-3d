 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(N,H){var G=N.length;N.push(H);e:for(;0<G;){var ee=G-1>>>1,ie=N[ee];if(0<r(ie,H))N[ee]=H,N[G]=ie,G=ee;else break e}}function n(N){return N.length===0?null:N[0]}function i(N){if(N.length===0)return null;var H=N[0],G=N.pop();if(G!==H){N[0]=G;e:for(var ee=0,ie=N.length,k=ie>>>1;ee<k;){var Z=2*(ee+1)-1,ce=N[Z],_e=Z+1,ve=N[_e];if(0>r(ce,G))_e<ie&&0>r(ve,ce)?(N[ee]=ve,N[_e]=G,ee=_e):(N[ee]=ce,N[Z]=G,ee=Z);else if(_e<ie&&0>r(ve,G))N[ee]=ve,N[_e]=G,ee=_e;else break e}}return H}function r(N,H){var G=N.sortIndex-H.sortIndex;return G!==0?G:N.id-H.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],c=[],f=1,d=null,h=3,m=!1,v=!1,x=!1,p=typeof setTimeout=="function"?setTimeout:null,u=typeof clearTimeout=="function"?clearTimeout:null,g=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function _(N){for(var H=n(c);H!==null;){if(H.callback===null)i(c);else if(H.startTime<=N)i(c),H.sortIndex=H.expirationTime,e(l,H);else break;H=n(c)}}function y(N){if(x=!1,_(N),!v)if(n(l)!==null)v=!0,q(C);else{var H=n(c);H!==null&&K(y,H.startTime-N)}}function C(N,H){v=!1,x&&(x=!1,u(D),D=-1),m=!0;var G=h;try{for(_(H),d=n(l);d!==null&&(!(d.expirationTime>H)||N&&!z());){var ee=d.callback;if(typeof ee=="function"){d.callback=null,h=d.priorityLevel;var ie=ee(d.expirationTime<=H);H=t.unstable_now(),typeof ie=="function"?d.callback=ie:d===n(l)&&i(l),_(H)}else i(l);d=n(l)}if(d!==null)var k=!0;else{var Z=n(c);Z!==null&&K(y,Z.startTime-H),k=!1}return k}finally{d=null,h=G,m=!1}}var R=!1,A=null,D=-1,S=5,T=-1;function z(){return!(t.unstable_now()-T<S)}function $(){if(A!==null){var N=t.unstable_now();T=N;var H=!0;try{H=A(!0,N)}finally{H?re():(R=!1,A=null)}}else R=!1}var re;if(typeof g=="function")re=function(){g($)};else if(typeof MessageChannel<"u"){var I=new MessageChannel,W=I.port2;I.port1.onmessage=$,re=function(){W.postMessage(null)}}else re=function(){p($,0)};function q(N){A=N,R||(R=!0,re())}function K(N,H){D=p(function(){N(t.unstable_now())},H)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(N){N.callback=null},t.unstable_continueExecution=function(){v||m||(v=!0,q(C))},t.unstable_forceFrameRate=function(N){0>N||125<N?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):S=0<N?Math.floor(1e3/N):5},t.unstable_getCurrentPriorityLevel=function(){return h},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(N){switch(h){case 1:case 2:case 3:var H=3;break;default:H=h}var G=h;h=H;try{return N()}finally{h=G}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(N,H){switch(N){case 1:case 2:case 3:case 4:case 5:break;default:N=3}var G=h;h=N;try{return H()}finally{h=G}},t.unstable_scheduleCallback=function(N,H,G){var ee=t.unstable_now();switch(typeof G=="object"&&G!==null?(G=G.delay,G=typeof G=="number"&&0<G?ee+G:ee):G=ee,N){case 1:var ie=-1;break;case 2:ie=250;break;case 5:ie=1073741823;break;case 4:ie=1e4;break;default:ie=5e3}return ie=G+ie,N={id:f++,callback:H,priorityLevel:N,startTime:G,expirationTime:ie,sortIndex:-1},G>ee?(N.sortIndex=G,e(c,N),n(l)===null&&N===n(c)&&(x?(u(D),D=-1):x=!0,K(y,G-ee))):(N.sortIndex=ie,e(l,N),v||m||(v=!0,q(C))),N},t.unstable_shouldYield=z,t.unstable_wrapCallback=function(N){var H=h;return function(){var G=h;h=H;try{return N.apply(this,arguments)}finally{h=G}}}})(Zm);Km.exports=Zm;var av=Km.exports;/**
 * @license React
...
`,Kw=()=>{const t=document.createElement("canvas");t.width=1,t.height=1;const e=t.getContext("2d");return e&&(e.fillStyle="#ffffff",e.fillRect(0,0,1,1)),new dc(t)},Zw=Kw(),Nm=t=>{const n=document.createElement("canvas");n.width=2048,n.height=2048;const i=n.getContext("2d");if(!i)return null;const r=2048/2,s=2048/2;i.clearRect(0,0,2048,2048);const o=(u,g,_,y)=>{i.beginPath(),i.arc(r,s,u,0,Math.PI*2),i.lineWidth=g,i.strokeStyle=_,i.globalAlpha=y,i.stroke()},a=t==="uranus",l=t==="neptune";let c,f;l?(c=1.5,f=2.8):a?(c=1.1,f=3.9):(c=1.3,f=2.3);const d=2048*.5,m=d*(c/f)-2,v=d-1,x=v-m;if(l){const u=A=>{const D=(A-c)/(f-c);return m+x*D},g="#8fa0b5";o(u(1.7),80,g,.15),o(u(2.16),3,g,.5);const _=u(2.16),C=u(2.32)-_,R=_+C/2;o(R,C,g,.08),o(u(2.32),3,g,.4),o(u(2.56),4,"#aabccd",.7)}else if(a){const u=K=>{const N=(K-c)/(f-c);return m+x*N},g="#aaaaaa",_="#ffffff",y="#691616",C="#17176e",R=u(1.62),A=u(1.2),D=i.createRadialGradient(r,s,A,r,s,R);D.addColorStop(0,"rgba(150, 150, 150, 0.0)"),D.addColorStop(.5,"rgba(150, 150, 150, 0.1)"),D.addColorStop(1,"rgba(150, 150, 150, 0.15)"),i.beginPath(),i.arc(r,s,R,0,Math.PI*2),i.arc(r,s,A,0,Math.PI*2,!0),i.fillStyle=D,i.fill(),o(u(1.65),1,g,.4),o(u(1.67),1,g,.4),o(u(1.69),1,g,.4),o(u(1.76),1.5,g,.6),o(u(1.79),1.5,g,.6),o(u(1.86),1.3,g,.6),o(u(1.89),1,g,.4),o(u(1.92),1.3,g,.6),o(u(1.97),1.3,g,.6),o(u(2.01),1.8,_,.8);const S=u(2.65),z=u(2.8)-S,$=S+z/2;o($,z,y,.14);const re=u(3.35),W=u(3.9)-re,q=re+W/2;o(q,z,C,.1)}else{const u=["#d3b589","#c2a278","#a49174","#8a7b63","#e0d0b0"];let _=.8,y=0;for(let C=m;C<v;C+=1.5){const R=(C-m)/(v-m);let A=.8,D=y;Math.random()>.95&&(D=Math.floor(Math.random()*u.length));let S=u[D];R<.15?(S="#5b5b6b",A=.15+Math.random()*.1):R<.6?(A=.9,Math.random()<.02&&(A=.6)):R<.65?(S="#000000",A=0):(A=.6,R>.9&&R<.92&&(A=.05,S="#111111"));let T=_*.8+A*.2+(Math.random()-.5)*.05;T=Math.max(0,Math.min(1,T));let z=1.5+Math.random()*.5;o(C,z,S,T),_=T,y=D}}const p=new dc(n);return p.minFilter=Ws,p.magFilter=Cn,p},Qw=()=>{const e=document.createElement("canvas");e.width=1024,e.height=1024;const n=e.getContext("2d");if(!n)return null;const i=1024/2,r=1024/2;n.clearRect(0,0,1024,1024);const s=n.createImageData(1024,1024),o=s.data;for(let a=0;a<1024;a++)for(let l=0;l<1024;l++){const c=l-i,f=a-i,h=Math.sqrt(c*c+f*f)/r;if(h<1){const m=Math.min(1,h/.7);let v=0;m<1&&(v=Math.pow(1-m,2.5));const x=(a*1024+l)*4;o[x]=255,o[x+1]=255,o[x+2]=255,o[x+3]=v*255}}return n.putImageData(s,0,0),new dc(e)},Jw=()=>{const t=document.createElement("canvas");t.width=64,t.height=64;const e=t.getContext("2d");if(!e)return null;const n=32,i=e.createRadialGradient(n,n,0,n,n,32);return i.addColorStop(0,"rgba(255, 255, 255, 0.9)"),i.addColorStop(.2,"rgba(255, 255, 255, 0.9)"),i.addColorStop(.3,"rgba(255, 255, 255, 0.8)"),i.addColorStop(.5,"rgba(255, 255, 255, 0.0)"),e.fillStyle=i,e.fillRect(0,0,64,64),new dc(t)},eA=({positions:t,selectedPlanetId:e,onSelectPlanet:n,showOrbits:i,solveKepler:r,speed:s,cameraResetTrigger:o=0,showAxialTilt:a=!1})=>{const l=de.useRef(null),c=de.useRef(null),f=de.useRef(null),d=de.useRef(null),h=de.useRef(null),m=de.useRef(null),v=de.useRef({}),x=de.useRef({}),p=de.useRef({}),u=de.useRef({}),g=de.useRef(null),_=de.useRef({}),y=de.useRef({}),C=de.useRef(null),R=de.useRef(null),A=de.useRef(null),D=de.useRef([]),S=de.useRef(new zw),T=de.useRef(new Bw),z=de.useRef(new Ue),$=de.useRef(null),re=de.useRef(null),I=de.useRef(e),W=de.useRef(null),q=de.useRef(null),K=de.useRef(!1),N=de.useRef(!1),H=de.useRef(s);de.useEffect(()=>{H.current=s},[s]);const G=de.useRef({x:0,y:0}),ee=de.useRef(!1);de.useEffect(()=>{I.current=e},[e]),de.useEffect(()=>{o>0&&(K.current=!0,N.current=!1,re.current=null)},[o]);const ie=de.useRef(n);return de.useEffect(()=>{ie.current=n},[n]),de.useEffect(()=>{Object.keys(_.current).forEach(k=>{const Z=_.current[k],ce=y.current[k],_e=a&&e===k;Z&&(Z.visible=_e),ce&&(ce.visible=_e)})},[a,e]),de.useEffect(()=>{var Le;if(!l.current)return;D.current=[];const k=new Rw;f.current=k;const Z=new Pn(Yt.FOV,l.current.clientWidth/l.current.clientHeight,Yt.NEAR,Yt.FAR);Z.position.set(Yt.INITIAL_POS.x,Yt.INITIAL_POS.y,Yt.INITIAL_POS.z),d.current=Z;const ce=new I_({antialias:!0,alpha:!0,powerPreference:"high-performance",logarithmicDepthBuffer:!0});ce.setSize(l.current.clientWidth,l.current.clientHeight),ce.setPixelRatio(Math.min(window.devicePixelRatio,2)),ce.shadowMap.enabled=!0,ce.shadowMap.type=Z0,ce.outputColorSpace=Dt,ce.toneMapping=J0,ce.toneMappingExposure=1.2;const _e=ce.capabilities.getMaxAnisotropy();l.current.appendChild(ce.domElement),h.current=ce;const ve=new Gw(Z,ce.domElement);ve.enableDamping=!0,ve.dampingFactor=.05,ve.minDistance=Yt.MIN_DISTANCE,ve.maxDistance=Yt.MAX_DISTANCE;const Oe=window.innerWidth<768?-1800:0;ve.target.set(Yt.INITIAL_TARGET.x,Yt.INITIAL_TARGET.y+Oe,Yt.INITIAL_TARGET.z),m.current=ve,ve.addEventListener("start",()=>{N.current=!1,K.current=!1});const Ie=new Uw(16777215,Ht.INTENSITY_FAR,0,0);Ie.position.set(0,0,0),Ie.castShadow=!1,k.add(Ie),R.current=Ie;const ue=new kw(16777215,.5);k.add(ue);const Ee=new Fw(16777215,4);Ee.castShadow=!0,Ee.shadow.mapSize.width=4096,Ee.shadow.mapSize.height=4096,Ee.shadow.bias=-1e-4,Ee.shadow.radius=3.5,Ee.visible=!1,k.add(Ee),k.add(Ee.target),C.current=Ee;const O=new br;k.add(O);const at=Jw(),be=mo.DUST_COUNT,Ne=new $t,Se=new Float32Array(be*3),ot=mo.RADIUS;for(let U=0;U<be;U++){const E=ot*(.6+Math.random()*.4),J=Math.random()*Math.PI*2,pe=Math.acos(Math.random()*2-1),ne=E*Math.sin(pe)*Math.cos(J),Q=E*Math.sin(pe)*Math.sin(J),P=E*Math.cos(pe);Se[U*3]=ne,Se[U*3+1]=Q,Se[U*3+2]=P}Ne.setAttribute("position",new En(Se,3));const He=new Lf({color:16777215,size:mo.DUST_SIZE,map:at,transparent:!0,opacity:1,sizeAttenuation:!0,depthWrite:!1,blending:Gi}),b=new Mm(Ne,He);b.renderOrder=-10,O.add(b);const M=mo.BRIGHT_COUNT,B=new $t,ae=new Float32Array(M*3),se=new Float32Array(M*3),le=[new Ze("#FFFFFF"),new Ze("#AABFFF"),new Ze("#FFDDAA"),new Ze("#FFBB88")];for(let U=0;U<M;U++){const E=Math.random()*Math.PI*2,J=Math.acos(Math.random()*2-1),pe=ot*(.8+Math.random()*.4),ne=pe*Math.sin(J)*Math.cos(E),Q=pe*Math.sin(J)*Math.sin(E),P=pe*Math.cos(J);ae[U*3]=ne,ae[U*3+1]=Q,ae[U*3+2]=P;const te=le[Math.floor(Math.random()*le.length)];se[U*3]=te.r,se[U*3+1]=te.g,se[U*3+2]=te.b}B.setAttribute("position",new En(ae,3)),B.setAttribute("color",new En(se,3));const Te=new Lf({size:mo.BRIGHT_SIZE,map:at,transparent:!0,opacity:1,vertexColors:!0,sizeAttenuation:!0,depthWrite:!1,blending:Gi}),ge=new Mm(B,Te);ge.renderOrder=-10,O.add(ge);const xe=new Iw;xe.crossOrigin="anonymous",rn.forEach(U=>{let E,J=new br,pe;if(U.id==="sun"){const ne={map:{value:Zw},time:{value:0}};pe=new Di({uniforms:ne,vertexShader:qw,fragmentShader:$w,transparent:!1,depthWrite:!0}),A.current=ne}else pe=new Su({color:U.color,map:null,roughness:1,metalness:0,emissive:0});if(U.texture&&U.texture.length>0&&xe.load(U.texture,ne=>{ne.colorSpace=Dt,ne.anisotropy=_e,U.id==="sun"?pe.uniforms.map.value=ne:(pe.map=ne,pe.color.setHex(16777215),pe.needsUpdate=!0)},void 0,ne=>console.warn(`Texture failed for ${U.id}`)),U.id==="sun"){const ne=new Io(U.radius,64,64);E=new jn(ne,pe),E.name="planetMesh",E.userData={id:U.id},D.current.push(E);const Q=Qw(),P=new Pf({map:Q,color:Ht.INNER_GLOW_COLOR,transparent:!0,opacity:Ht.INNER_GLOW_OPACITY,blending:Gi,depthWrite:!1}),te=new _m(P);te.scale.set(U.radius*Ht.INNER_GLOW_SIZE_MULT,U.radius*Ht.INNER_GLOW_SIZE_MULT,1),E.add(te);const he=new Pf({map:Q,color:Ht.OUTER_GLOW_COLOR,transparent:!0,opacity:Ht.OUTER_GLOW_OPACITY,blending:Gi,depthWrite:!1}),Ce=new _m(he);Ce.scale.set(U.radius*Ht.OUTER_GLOW_SIZE_MULT,U.radius*Ht.OUTER_GLOW_SIZE_MULT,1),E.add(Ce),k.add(E),v.current[U.id]=E}else{const ne=new br;let Q=k;U.parentId&&U.id!=="moon"?x.current[U.parentId]?Q=x.current[U.parentId]:v.current[U.parentId]&&(Q=v.current[U.parentId]):U.parentId&&v.current[U.parentId]&&(Q=v.current[U.parentId]),Q.add(ne),v.current[U.id]=ne,J.rotation.z=U.axialTilt*(Math.PI/180),ne.add(J),x.current[U.id]=J;const P=new Io(U.radius,64,64);E=new jn(P,pe),E.name="planetMesh",E.userData={id:U.id},D.current.push(E),E.castShadow=!0,E.receiveShadow=!0,J.add(E);const te=U.radius*1.5,he=[new L(0,-te,0),new L(0,te,0)],Ce=new $t().setFromPoints(he),Ae=new Od({color:16777215,depthTest:!1,transparent:!0,opacity:1}),Be=new yu(Ce,Ae);Be.visible=!1,Be.renderOrder=999,J.add(Be),_.current[U.id]=Be;const Ve=[new L(0,-te,0),new L(0,te,0)],it=new $t().setFromPoints(Ve),lt=new Cw({color:16777215,dashSize:U.radius*.025,gapSize:U.radius*.025,transparent:!0,opacity:1,depthTest:!1}),We=new yu(it,lt);if(We.computeLineDistances(),We.visible=!1,We.renderOrder=998,ne.add(We),y.current[U.id]=We,U.id==="earth"){const ct=new Io(U.radius*1.02,64,64),ft=new Su({map:null,transparent:!0,opacity:0,side:Gn,blending:Gi,depthWrite:!1,roughness:1,emissive:0});U.cloudTexture&&xe.load(U.cloudTexture,jt=>{jt.colorSpace=Dt,jt.anisotropy=_e,ft.alphaMap=jt,ft.color.setHex(16777215),ft.blending=Lr,ft.opacity=.9,ft.needsUpdate=!0});const Wt=new jn(ct,ft);E.add(Wt),g.current=Wt}if(U.id==="saturn"||U.id==="uranus"||U.id==="neptune"){const ct=U.id==="uranus",ft=U.id==="neptune";let Wt,jt;ft?(Wt=U.radius*1.5,jt=U.radius*2.8):ct?(Wt=U.radius*1.3,jt=U.radius*3.9):(Wt=U.radius*1.3,jt=U.radius*2.3);const wn=new Fd(Wt,jt,256),Re=new Su({color:16777215,side:Gn,shadowSide:Gn,transparent:!0,opacity:.95,roughness:.4,metalness:.1,emissive:0,alphaTest:.05}),qe=new D_({depthPacking:c_,map:null,alphaTest:.05});if(U.ringTexture)xe.load(U.ringTexture,rt=>{rt.anisotropy=_e,Re.map=rt,Re.needsUpdate=!0,qe.map=rt,qe.needsUpdate=!0},void 0,()=>{const rt=Nm(U.id);rt&&(rt.anisotropy=_e,Re.map=rt,Re.needsUpdate=!0,qe.map=rt,qe.needsUpdate=!0)});else{const rt=Nm(U.id);rt&&(rt.anisotropy=_e,Re.map=rt,qe.map=rt)}const we=wn.attributes.position,et=wn.attributes.uv;for(let rt=0;rt<we.count;rt++){const zt=we.getX(rt),w=we.getY(rt),F=jt,V=zt/F*.5+.5,X=w/F*.5+.5;et.setXY(rt,V,X)}const yt=new jn(wn,Re);yt.customDepthMaterial=qe,yt.rotation.x=-Math.PI/2,yt.castShadow=!1,yt.receiveShadow=!0,J.add(yt)}}if(U.id!=="sun"){const ne=[],Q=[],P=Math.min(2e4,Math.max(256,Math.floor(U.orbitRadius)));let te=0;for(let it=0;it<=P;it++){const lt=it/P*2*Math.PI,We=r(lt,U.eccentricity),ct=U.orbitRadius,ft=U.eccentricity,Wt=ct*Math.sqrt(1-ft*ft),jt=ct*(Math.cos(We)-ft),wn=Wt*Math.sin(We),Re=U.orbitAngle*Math.PI/180,qe=jt*Math.cos(Re)-wn*Math.sin(Re),we=jt*Math.sin(Re)+wn*Math.cos(Re);let et=Math.atan2(we,qe);if(it>0){let zt=et-te;for(;zt<=-Math.PI;)zt+=2*Math.PI;for(;zt>Math.PI;)zt-=2*Math.PI;et=te+zt}te=et;const yt=U.inclination*Math.PI/180,rt=U.orbitRadius*Math.sin(yt)*Math.sin(et);ne.push(new L(qe,rt,we)),Q.push(et)}const he=new $t().setFromPoints(ne);he.setAttribute("lineAngle",new pn(Q,1));const Ce=Xw(),Ae=new Ze(U.color).lerp(new Ze(16777215),yo.COLOR_DESATURATION),Be=new Di({uniforms:{color:{value:Ae},currentAngle:{value:0},hoverState:{value:0}},vertexShader:Yw,fragmentShader:Ce,transparent:!0,depthWrite:!1,blending:Gi}),Ve=new yu(he,Be);U.parentId&&U.id!=="moon"&&x.current[U.parentId]?x.current[U.parentId].add(Ve):U.parentId&&v.current[U.parentId]?v.current[U.parentId].add(Ve):k.add(Ve),p.current[U.id]=Ve}if(c.current){const ne=document.createElement("div");ne.className="planet-label",ne.textContent=U.name.split(" ")[0],ne.onclick=()=>ie.current(U.id),ne.onmouseenter=()=>{q.current=U.id},ne.onmouseleave=()=>{q.current=null};const Q=U.id==="moon"?"50%":"-120%";ne.style.transform=`translate(-50%, ${Q})`,c.current.appendChild(ne),u.current[U.id]=ne}}),(()=>{Object.keys(_.current).forEach(U=>{_.current[U],y.current[U]})})();const Ge=new ResizeObserver(U=>{for(let E of U)if(E.target===l.current&&d.current&&h.current){const J=E.contentRect.width,pe=E.contentRect.height;d.current.aspect=J/pe,d.current.updateProjectionMatrix(),h.current.setSize(J,pe)}});Ge.observe(l.current);const oe=U=>{ee.current=!1,G.current={x:U.clientX,y:U.clientY}},nt=U=>{const E=U.clientX-G.current.x,J=U.clientY-G.current.y;if((Math.abs(E)>5||Math.abs(J)>5)&&(ee.current=!0),U.pointerType==="mouse"&&l.current&&d.current){const pe=h.current.domElement.getBoundingClientRect();z.current.x=(U.clientX-pe.left)/pe.width*2-1,z.current.y=-((U.clientY-pe.top)/pe.height)*2+1,T.current.setFromCamera(z.current,d.current);const ne=T.current.intersectObjects(D.current,!1);l.current.style.cursor=ne.length>0?"pointer":"default",q.current=ne.length>0?ne[0].object.userData.id:null}},Xe=U=>{if(ee.current||!l.current||!d.current)return;const E=h.current.domElement.getBoundingClientRect();z.current.x=(U.clientX-E.left)/E.width*2-1,z.current.y=-((U.clientY-E.top)/E.height)*2+1,T.current.setFromCamera(z.current,d.current);const J=T.current.intersectObjects(D.current,!1);J.length>0&&ie.current(J[0].object.userData.id)};(Le=h.current)!=null&&Le.domElement&&(h.current.domElement.addEventListener("pointerdown",oe),h.current.domElement.addEventListener("pointermove",nt),h.current.domElement.addEventListener("pointerup",Xe),h.current.domElement.style.touchAction="none");const ze=()=>{if(!l.current)return;$.current=requestAnimationFrame(ze);const U=S.current.getDelta(),E=I.current,J=W.current,pe=q.current;if(A.current&&(A.current.time.value+=U),E&&E!=="sun"?(R.current&&(R.current.intensity=Ht.INTENSITY_NEAR),C.current&&(C.current.visible=!0)):(R.current&&(R.current.intensity=Ht.INTENSITY_FAR),C.current&&(C.current.visible=!1)),E&&E!=="sun"&&C.current){const Re=v.current[E];if(Re){const qe=new L,we=x.current[E],et=we?we.children.find(V=>V.name==="planetMesh"):null;et?et.getWorldPosition(qe):Re.getWorldPosition(qe);const yt=qe.clone().normalize().negate(),rt=rn.find(V=>V.id===E),zt=rt?rt.radius:1,w=Math.max(2,zt*10);C.current.position.copy(qe).add(yt.multiplyScalar(w)),C.current.target.position.copy(qe);const F=Math.max(.1,zt*5);C.current.shadow.camera.left=-F,C.current.shadow.camera.right=F,C.current.shadow.camera.top=F,C.current.shadow.camera.bottom=-F,C.current.shadow.camera.near=.01,C.current.shadow.camera.far=w*3,C.current.shadow.camera.updateProjectionMatrix()}}rn.forEach(Re=>{const qe=Re.id===E||Re.id===pe;if(p.current[Re.id]){const we=p.current[Re.id];we.material.uniforms.hoverState&&(we.material.uniforms.hoverState.value=qe?1:0)}if(u.current[Re.id]){const we=u.current[Re.id];qe?(we.style.color="#ffffff",we.style.textShadow=`0 0 15px ${Re.color}, 0 0 30px ${Re.color}`,we.style.opacity="1.0",we.style.fontWeight="700",we.style.zIndex="100"):(we.style.color="rgba(255, 255, 255, 0.9)",we.style.textShadow="0 2px 4px rgba(0,0,0,0.8)",we.style.opacity="0.9",we.style.fontWeight="500",we.style.zIndex="1")}}),g.current&&(g.current.rotation.y+=5e-5);let ne=new L(0,0,0),Q=!1;if(J&&!E&&(K.current=!0,N.current=!1,re.current=null),E&&(K.current=!1,E!==J&&(N.current=!0,re.current=null)),E&&v.current[E]){const Re=v.current[E];if(E==="sun")Re.getWorldPosition(ne),Q=!0;else{const qe=x.current[E],we=qe?qe.children.find(et=>et.name==="planetMesh"):null;we&&(we.getWorldPosition(ne),Q=!0)}}if(Q&&E&&!K.current){if(re.current){const Re=new L().subVectors(ne,re.current);m.current.target.add(Re),d.current.position.add(Re)}re.current||(re.current=new L),re.current.copy(ne)}const P=1-Math.exp(-4*U);if(K.current){const qe=window.innerWidth<768?-2500:0,we=new L(Yt.INITIAL_TARGET.x,Yt.INITIAL_TARGET.y+qe,Yt.INITIAL_TARGET.z),et=new L(Yt.INITIAL_POS.x,Yt.INITIAL_POS.y,Yt.INITIAL_POS.z);m.current.target.lerp(we,P),d.current.position.lerp(et,P);const yt=m.current.target.distanceTo(we),rt=d.current.position.distanceTo(et);yt<1&&rt<5&&(m.current.target.copy(we),d.current.position.copy(et),K.current=!1)}else if(E){const Re=m.current.target;if(Re.distanceTo(ne)>.001?Re.lerp(ne,P):Re.copy(ne),N.current){const we=rn.find(et=>et.id===E);if(we){const et=d.current.fov*Math.PI/180;let yt=we.radius;(we.id==="saturn"||we.id==="uranus"||we.id==="neptune")&&(yt*=jw),we.id==="sun"&&(yt*=1.1);const zt=l.current.clientWidth<768?Ww:Vw,w=d.current.aspect,F=yt/(Math.tan(et/2)*zt),V=yt/(Math.tan(et*w/2)*zt);let X=Math.max(F,V);const Y=we.radius*1.2;if(X=Math.max(X,Y),we.id!=="sun"){const ke=new L(0,0,0),$e=new L().subVectors(d.current.position,Re).normalize(),je=new L().subVectors(ke,Re).normalize();if($e.dot(je)>.8){const St=new L(0,1,0);let Xt=new L().crossVectors(je,St).normalize();Xt.lengthSq()<.1&&Xt.set(1,0,0);const Pt=Xt.multiplyScalar(X).add(new L(0,X*.4,0)),On=new L().addVectors(Re,Pt);d.current.position.lerp(On,P),d.current.position.distanceTo(On)<we.radius*.5&&(N.current=!1),m.current.update(),h.current.render(f.current,d.current)}}const ye=new L().subVectors(d.current.position,Re),Pe=ye.length(),Fe=Math.max(we.radius*.01,1e-4);if(Math.abs(Pe-X)>Fe){const ke=d_.lerp(Pe,X,P);ye.setLength(ke),d.current.position.copy(Re).add(ye)}else N.current=!1}}}if(W.current=E,m.current.update(),h.current.render(f.current,d.current),v.current.sun){const Re=rn.find(et=>et.id==="sun"),we=H.current/625e-6;v.current.sun.rotation.y+=.01*((Re==null?void 0:Re.rotationSpeed)||.037)*we}const te={},he=l.current.clientWidth,Ce=l.current.clientHeight;rn.forEach(Re=>{const qe=v.current[Re.id];if(qe){const we=new L;if(Re.id==="sun")qe.getWorldPosition(we);else{const rt=x.current[Re.id],zt=rt?rt.children.find(w=>w.name==="planetMesh"):null;zt?zt.getWorldPosition(we):qe.getWorldPosition(we)}we.y+=Re.radius*1.5,we.project(d.current);const et=(we.x*.5+.5)*he,yt=(-(we.y*.5)+.5)*Ce;te[Re.id]={x:et,y:yt,z:we.z}}});const Ae=te.jupiter,Be=te.callisto;let Ve=!1;const it=90;Ae&&Be&&Ae.z<1&&Be.z<1&&Math.sqrt(Math.pow(Ae.x-Be.x,2)+Math.pow(Ae.y-Be.y,2))<it&&(Ve=!0);const lt=te.saturn,We=te.titan;let ct=!1;lt&&We&&lt.z<1&&We.z<1&&Math.sqrt(Math.pow(lt.x-We.x,2)+Math.pow(lt.y-We.y,2))<it&&(ct=!0);const ft=te.earth,Wt=te.moon;let jt=!1;ft&&Wt&&ft.z<1&&Wt.z<1&&Math.sqrt(Math.pow(ft.x-Wt.x,2)+Math.pow(ft.y-Wt.y,2))<it&&(jt=!0);const wn=["io","europa","ganymede","callisto"];rn.forEach(Re=>{const qe=u.current[Re.id],we=te[Re.id];if(qe&&we){let et=!0;if((we.z>1||Math.abs(we.x-he/2)>he/2+100||Math.abs(we.y-Ce/2)>Ce/2+100)&&(et=!1),et&&wn.includes(Re.id)&&Ve&&(et=!1),et&&Re.id==="titan"&&ct&&(et=!1),et&&Re.id==="moon"&&jt&&(et=!1),!et)qe.style.display="none";else{qe.style.display="block";let yt="-120%",rt="-50%";Re.id==="moon"&&(yt="50%"),qe.style.transform=`translate(${rt}, ${yt}) translate3d(${we.x}px, ${we.y}px, 0)`,qe.style.left="0px",qe.style.top="0px"}}})};return ze(),()=>{var U,E;$.current&&cancelAnimationFrame($.current),Ge.disconnect(),(U=h.current)!=null&&U.domElement&&(h.current.domElement.removeEventListener("pointerdown",oe),h.current.domElement.removeEventListener("pointermove",nt),h.current.domElement.removeEventListener("pointerup",Xe)),(E=l.current)==null||E.removeChild(h.current.domElement),c.current&&(c.current.innerHTML="")}},[]),de.useEffect(()=>{t.forEach(k=>{var ce;const Z=v.current[k.id];if(Z&&(Z.position.set(k.x,k.y,k.z),k.id!=="sun")){const _e=x.current[k.id];if(_e){const Oe=_e.children.find(Ie=>Ie.name==="planetMesh");if(Oe)if(k.id==="moon"||["io","europa","ganymede","callisto","titan"].includes(k.id))Oe.rotation.y=-k.angle-Math.PI/2;else{const Ie=((ce=rn.find(O=>O.id===k.id))==null?void 0:ce.rotationSpeed)||1,Ee=s/625e-6;Oe.rotation.y+=.01*Ie*Ee}}const ve=p.current[k.id];ve&&ve.material.uniforms&&(ve.material.uniforms.currentAngle.value=k.angle)}})},[t,s]),de.useEffect(()=>{Object.values(p.current).forEach(k=>{k.visible=i})},[i]),j.jsxs("div",{className:"w-full h-full relative bg-black",children:[j.jsx("div",{ref:l,className:"w-full h-full"}),j.jsx("div",{ref:c,id:"label-container"})]})},tA=Xl.memo(eA);/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const oA=de.forwardRef(({color:t="currentColor",size:e=24,strokeWidth:n=2,absoluteStrokeWidth:i,className:r="",children:s,iconNode:o,...a},l)=>de.createElement("svg",{ref:l,...sA,width:e,height:e,stroke:t,strokeWidth:i?Number(n)*24/Number(e):n,className:O_("lucide",r),...!s&&!rA(a)&&{"aria-hidden":"true"},...a},[...o.map(([c,f])=>de.createElement(c,f)),...Array.isArray(s)?s:[s]]));/**
 * @license lucide-react v0.556.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Tn=(t,e)=>{const n=de.forwardRef(({className:i,...r},s)=>de.createElement(oA,{ref:s,iconNode:e,className:O_(`lucide-${nA(Um(t))}`,`lucide-${t}`,i),...r}));return n.displayName=Um(t),n};/**
 * @license lucide-react v0.556.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const _A=[["path",{d:"M15 14c.2-1 .7-1.7 1.5-2.5 1-.9 1.5-2.2 1.5-3.5A6 6 0 0 0 6 8c0 1 .2 2.2 1.5 3.5.7.7 1.3 1.5 1.5 2.5",key:"1gvzjb"}],["path",{d:"M9 18h6",key:"x1upvd"}],["path",{d:"M10 22h4",key:"ceow96"}]],Om=Tn("lightbulb",_A);/**
 * @license lucide-react v0.556.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
3. 專業建議：${o}`},FA=({planet:t,calculateRealPosition:e,earthRealPosition:n,onClose:i,showAxialTilt:r,onToggleAxialTilt:s})=>{const[o,a]=de.useState("intro"),[l,c]=de.useState(""),[f,d]=de.useState(!1),[h,m]=de.useState(!1),v=de.useRef(null),[x,p]=Xl.useMemo(()=>{var S;const D=t.description.split("【冷知識】");return[D[0].trim(),(S=D[1])==null?void 0:S.trim()]},[t.description]),u=D=>{let S=Math.atan2(D.y,D.x)*(180/Math.PI);return S<0&&(S+=360),S},g=()=>{if(t.id==="sun"||t.id==="earth")return"";if(t.id==="moon")return"模型幾何計算參考: 月相隨地月日相對位置而變化";const D=e(t.id),S=n,T=u(D),z=u(S);let $=T-z;$<0&&($+=360);const re=t.orbitRadius<2490;let I="";if(re){const W=-S.x,q=-S.y,K=D.x-S.x,N=D.y-S.y;W*N-q*K>0?I="東大距側 (昏星/日落後可見)":I="西大距側 (晨星/日出前可見)"}else Math.abs($-180)<20?I="衝 (Opposition) - 整夜可見，最亮":$<20||$>340?I="合 (Conjunction) - 接近太陽，不可見":I="一般觀測期";return`模型幾何計算參考: 行星位於太陽${I}`},_=()=>t.parentId==="jupiter"?"(對木星赤道)":t.parentId==="saturn"?"(對土星赤道)":"(對黃道)",y=D=>{if(D===0)return"0";const S=D.toString();return S.includes(".")?S.split(".")[1].length<2?D.toFixed(2):S:D.toFixed(2)};de.useEffect(()=>{c(""),d(!1),m(!1),a("intro"),v.current&&(v.current.scrollTop=0)},[t.id]),de.useEffect(()=>{v.current&&(v.current.scrollTop=0)},[o]);const C=()=>{m(!0),d(!0);const D=new Date().toLocaleDateString("zh-HK",{year:"numeric",month:"long",day:"numeric"}),S=g();OA(t.name,D,S).then(T=>{c(T),d(!1)})},R=({label:D,value:S,isLast:T=!1,action:z})=>j.jsxs("div",{className:`flex justify-between py-4 mr-5 ml-5 ${T?"":"border-b border-slate-800"}`,children:[j.jsx("span",{className:"text-sm font-medium text-slate-400 tracking-wide break-keep pr-3",children:D}),j.jsxs("div",{className:"flex md:flex-wrap-reverse text-right items-center gap-3 ml-auto",children:[z,j.jsx("span",{className:"text-sm font-mono font-bold text-slate-300 text-right ml-auto",children:S})]})]}),A=t.id!=="earth"&&t.id!=="sun";return j.jsxs("div",{className:"w-full font-sans h-full relative flex flex-col overflow-hidden",children:[j.jsxs("div",{className:"flex-shrink-0 z-30 bg-slate-950 border-b border-slate-800/50 pt-0 md:pt-6 shadow-2xl transition-all duration-300 relative",children:[j.jsxs("div",{className:`hidden md:flex flex-col gap-5 px-6 ${A?"mb-5":""}`,children:[j.jsxs("button",{onClick:i,className:"flex items-center gap-2 text-slate-400 hover:text-white transition-colors group w-max",children:[j.jsx("div",{className:"flex items-center justify-center rounded-full shadow-md transition-all duration-300",children:j.jsx(lA,{size:20})}),j.jsx("span",{className:"text-sm font-bold uppercase tracking-wide",children:"返回"})]}),j.jsxs("div",{children:[j.jsx("h2",{className:"text-xl font-bold text-slate-200 flex items-center gap-3 leading-7",children:j.jsx("span",{children:t.name})}),j.jsx("p",{className:"text-indigo-400 text-sm font-bold uppercase tracking-widest mt-1.5",children:t.type==="terrestrial"?"類地行星":t.type==="gas"?"氣態巨行星":t.type==="ice"?"冰巨行星":t.type==="moon"?"衛星":"恆星"})]})]}),A&&j.jsx("div",{className:"hidden md:block w-full h-px bg-slate-800/50"}),A&&j.jsxs("div",{className:"relative flex w-full",children:[j.jsxs("button",{onClick:()=>a("intro"),className:`flex-1 py-3 text-sm font-bold tracking-widest uppercase transition-colors duration-300 flex items-center justify-center gap-2 ${o==="intro"?"text-indigo-400":"text-slate-400 hover:text-slate-300"}`,children:[j.jsx(uA,{size:16,className:`transition-opacity duration-300 ${o==="intro"?"opacity-100":"opacity-70"}`}),"簡介"]}),j.jsxs("button",{onClick:()=>a("observation"),className:`flex-1 py-3 text-sm font-bold tracking-widest uppercase transition-colors duration-300 flex items-center justify-center gap-2 ${o==="observation"?"text-indigo-400":"text-slate-400 hover:text-slate-300"}`,children:[j.jsx(Fm,{size:16,className:`transition-opacity duration-300 ${o==="observation"?"opacity-100":"opacity-70"}`}),"觀測指南"]}),j.jsx("div",{className:"absolute bottom-0 h-[2px] bg-indigo-500 transition-all duration-300 ease-out shadow-[0_-1px_6px_rgba(99,102,241,0.5)]",style:{left:o==="intro"?"0%":"50%",width:"50%"}})]}),!A&&j.jsx("div",{className:"hidden md:block pb-5"})]}),j.jsxs("div",{ref:v,className:"flex-1 overflow-y-auto custom-scrollbar px-6 pb-8 pt-6 [scrollbar-gutter:stable] animate-in fade-in slide-in-from-bottom-2 duration-500",children:[o==="intro"&&j.jsxs("div",{className:"space-y-8",children:[j.jsxs("div",{className:"space-y-6",children:[j.jsx("p",{className:"text-slate-300 text-sm font-normal leading-6 text-justify whitespace-pre-line",children:x}),p&&j.jsxs("div",{className:"relative overflow-hidden bg-gradient-to-br from-indigo-950/40 to-purple-900/10 border border-indigo-500/30 rounded-xl p-5 shadow-inner",children:[j.jsx("div",{className:"absolute -bottom-4 -right-4 text-indigo-500/5 transform rotate-12 pointer-events-none",children:j.jsx(Om,{size:100})}),j.jsxs("div",{className:"relative z-10 space-y-2",children:[j.jsxs("h4",{className:"text-sm text-indigo-400 font-bold uppercase tracking-widest flex items-center gap-2",children:[j.jsx(Om,{size:14,className:"text-indigo-400"}),"星際冷知識"]}),j.jsx("p",{className:"text-slate-300 text-sm font-normal leading-6 text-justify",children:p})]})]})]}),j.jsx("div",{children:j.jsxs("div",{className:"bg-slate-900/60 backdrop-blur-sm rounded-xl border border-slate-800 overflow-hidden",children:[t.id!=="sun"&&j.jsx(R,{label:"公轉週期",value:t.period===0?"N/A":`${t.period} 年`}),j.jsx(R,{label:"自轉週期",value:t.rotationPeriod}),j.jsx(R,{label:"轉軸傾角",value:`${y(t.axialTilt)}°`,action:t.id!=="sun"&&t.axialTilt>=1?j.jsx("button",{onClick:D=>{D.stopPropagation(),s()},className:`px-3 py-1.5 rounded-lg transition-all duration-300 flex items-center justify-center gap-2 text-xs font-medium border ml-auto -mt-1 -mb-1 ${r?"bg-indigo-600 text-white border-transparent shadow-[0_0_10px_rgba(79,70,229,0.5)]":"bg-slate-800 text-slate-300 border-slate-700 hover:text-indigo-400 hover:border-indigo-500/50"}`,title:r?"隱藏轉軸":"顯示轉軸",children:j.jsx("span",{children:r?"隱藏轉軸":"顯示轉軸"})}):void 0}),t.id!=="sun"&&j.jsx(R,{label:"軌道傾角",value:`${y(t.inclination)}° ${_()}`}),t.volume&&j.jsx(R,{label:"體積",value:t.volume}),t.mass&&j.jsx(R,{label:"質量",value:t.mass}),j.jsx(R,{label:"表面溫度",value:t.temperature}),t.gravity&&j.jsx(R,{label:"表面重力",value:t.gravity}),t.id!=="earth"&&j.jsx(R,{label:"視星等",value:t.magnitude}),t.type!=="moon"&&t.id!=="sun"&&j.jsx(R,{label:"已知衛星數目",value:t.moons,isLast:!0})]})})]}),o==="observation"&&A&&j.jsxs("div",{className:"space-y-8",children:[j.jsx("div",{children:t.observationInfo?j.jsx("p",{className:"text-slate-300 text-sm font-normal leading-6 text-justify whitespace-pre-line",children:t.observationInfo}):j.jsx("p",{className:"text-slate-400 italic",children:"暫無詳細觀測資料。"})}),j.jsx("div",{children:h?f?j.jsxs("div",{className:"flex flex-col items-center gap-3 text-slate-300 text-sm py-8 justify-center bg-slate-950/50 rounded-xl border border-slate-800/50",children:[j.jsx(xA,{className:"animate-spin text-indigo-400",size:24}),j.jsx("span",{children:"正在分析天體位置與實時數據..."})]}):j.jsxs("div",{className:"text-sm text-slate-300 space-y-3 whitespace-pre-wrap leading-6 animate-in fade-in slide-in-from-bottom-2 bg-slate-950/50 p-5 rounded-xl border border-slate-800/60",children:[l,j.jsxs("div",{className:"mt-4 pt-3 border-t border-slate-800/50 text-xs text-slate-400 text-right flex items-center justify-end gap-1.5",children:[j.jsx(RA,{size:14,className:"text-indigo-400"}),j.jsx("span",{children:"Powered by AI (demo only)"})]})]}):j.jsxs("button",{onClick:C,className:"w-full py-3 bg-indigo-600 hover:bg-indigo-500 text-slate-200 text-sm font-medium rounded-lg transition-all flex items-center justify-center gap-2 shadow-lg shadow-indigo-900/20 active:scale-[0.98]",children:[j.jsx(Fm,{size:18}),"獲取今日香港觀測詳情"]})})]})]})]})},kA=Xl.memo(FA),wu=({p:t,onClick:e})=>{var r;const n=((r=t.name.split("(")[1])==null?void 0:r.replace(")",""))||"",i=t.name.split(" ")[0];return j.jsxs("button",{onClick:()=>e(t.id),className:"group relative flex flex-col justify-center p-3 rounded-lg bg-slate-800/40 hover:bg-slate-700/60 border border-slate-700/50 hover:border-indigo-500/50 transition-all duration-300 overflow-hidden text-left shadow-sm hover:shadow-lg hover:shadow-indigo-900/20",children:[j.jsxs("div",{className:"flex items-center gap-3 relative z-10",children:[j.jsx("div",{className:"w-10 h-10 rounded-full flex-shrink-0 shadow-lg group-hover:scale-110 transition-transform duration-500 border border-white/10",style:{background:`radial-gradient(circle at 30% 30%, ${t.color}, #1a1a1a)`,boxShadow:`0 0 10px ${t.color}40`}}),j.jsxs("div",{className:"flex flex-col min-w-0",children:[j.jsx("span",{className:"text-sm font-bold text-slate-200 group-hover:text-white truncate",children:i}),j.jsx("span",{className:"text-xs font-bold text-slate-400 uppercase tracking-wider group-hover:text-indigo-300 transition-colors truncate",children:n})]})]}),j.jsx("div",{className:"absolute inset-0 bg-gradient-to-br from-indigo-500/0 via-indigo-500/0 to-indigo-500/0 group-hover:from-indigo-500/5 group-hover:to-purple-500/10 transition-all duration-500"})]})},zA=()=>{const[t,e]=de.useState(!0),[n,i]=de.useState(625e-6),[r,s]=de.useState(0),[o,a]=de.useState(0),[l,c]=de.useState(null),[f,d]=de.useState(!0),[h,m]=de.useState(0),[v,x]=de.useState(!1),[p,u]=de.useState(null),[g,_]=de.useState(!1),y=de.useRef(null),C=de.useRef(void 0),R=de.useRef(n),A=de.useRef(t),D=de.useRef(null),S=de.useRef(null),T=de.useRef(null);de.useEffect(()=>{R.current=n},[n]),de.useEffect(()=>{A.current=t},[t]),de.useEffect(()=>{if(l){const ue=rn.find(Ee=>Ee.id===l)||null;ue&&u(ue),_(!1)}else T.current&&(T.current.scrollTop=0,requestAnimationFrame(()=>{T.current&&(T.current.scrollTop=0)}));x(!1)},[l]),de.useEffect(()=>{const ue=new Date("2000-01-01T12:00:00Z").getTime(),O=(new Date().getTime()-ue)/(1e3*60*60*24);a(O)},[]);const z=de.useCallback((ue,Ee)=>{let O=ue;const at=1e-6;for(let be=0;be<5;be++){const Ne=O-Ee*Math.sin(O)-ue,Se=1-Ee*Math.cos(O);if(O=O-Ne/Se,Math.abs(Ne)<at)break}return O},[]),$=de.useCallback((ue,Ee)=>{const O=rn.find(nt=>nt.id===ue);if(O.id==="sun")return{id:O.id,x:0,y:0,z:0,scale:1,angle:0,distanceFromSun:0};const at=O.period*365.25,Ne=2*Math.PI/at*Ee,Se=z(Ne,O.eccentricity),ot=O.orbitRadius,He=O.eccentricity,b=ot*Math.sqrt(1-He*He),M=ot*(Math.cos(Se)-He),B=b*Math.sin(Se),ae=O.orbitAngle*Math.PI/180,se=M*Math.cos(ae)-B*Math.sin(ae),le=M*Math.sin(ae)+B*Math.cos(ae),Te=Math.atan2(le,se),ge=O.inclination*Math.PI/180,xe=O.orbitRadius*Math.sin(ge)*Math.sin(Te);let De=se,Ge=xe,oe=le;return{id:O.id,x:De,y:Ge,z:oe,scale:1,angle:Te,distanceFromSun:Math.sqrt(De*De+oe*oe)}},[z]),re=rn.map(ue=>$(ue.id,r)),I=de.useCallback(ue=>{if(C.current!==void 0){const Ee=ue-C.current;A.current&&s(O=>O+Ee*R.current*.5)}C.current=ue,y.current=requestAnimationFrame(I)},[]);de.useEffect(()=>(y.current=requestAnimationFrame(I),()=>{y.current&&cancelAnimationFrame(y.current)}),[I]);const W=ue=>{c(ue),_(!1)},q=ue=>{c(ue),_(!1)},K=()=>{c(null),m(ue=>ue+1),_(!1)},N=de.useCallback(()=>{x(ue=>!ue)},[]),H=de.useCallback(()=>{c(null)},[]),G=de.useCallback(ue=>{const Ee=$(ue,o),O=rn.find(at=>at.id===ue);if(O!=null&&O.parentId){const at=$(O.parentId,o);return{...Ee,x:Ee.x+at.x,y:Ee.y+at.y,z:Ee.z+at.z}}return Ee},[$,o]),ee=de.useMemo(()=>$("earth",o),[$,o]),ie=de.useMemo(()=>rn.filter(ue=>ue.type==="star"),[]),k=de.useMemo(()=>rn.filter(ue=>["terrestrial","gas","ice"].includes(ue.type)),[]),Z=de.useMemo(()=>rn.filter(ue=>ue.type==="moon"),[]),ce=de.useMemo(()=>l?p?p.name:"Loading...":"選擇天體",[l,p]),_e=de.useMemo(()=>!l||!p?"Default":p.type==="terrestrial"?"類地行星":p.type==="gas"?"氣態巨行星":p.type==="ice"?"冰巨行星":p.type==="moon"?"衛星":"恆星",[l,p]),ve=l?"5.5rem":"3.5rem",Oe=g?"h-[70dvh]":l?"h-[5.5rem]":"h-[3.5rem]",Ie=g?"calc(70dvh + 24px)":`calc(${ve} + 24px)`;return j.jsxs("div",{className:"w-full h-[100dvh] flex flex-col md:flex-row bg-[#020617] overflow-hidden text-slate-100 font-sans relative",children:[j.jsxs("aside",{ref:D,className:`
        ...
        `,children:[j.jsxs("div",{className:`md:hidden flex items-center justify-between px-6 bg-slate-900/80 border-b border-slate-800 cursor-pointer touch-none transition-all duration-300 ${l?"h-24 py-4":"h-14 py-3"}`,onClick:()=>_(!g),children:[j.jsxs("div",{className:"flex flex-col justify-center gap-1",children:[j.jsx("span",{className:`${l?"text-xl font-bold text-slate-200":"text-base font-bold text-slate-300"}`,children:ce}),l&&j.jsx("span",{className:"text-indigo-400 text-sm font-bold uppercase tracking-widest animate-in fade-in slide-in-from-left-2",children:_e})]}),j.jsx("div",{className:"text-slate-400",children:g?j.jsx(dA,{size:20}):j.jsx(pA,{size:20})})]}),j.jsxs("div",{className:"relative w-full flex-1 overflow-hidden",children:[j.jsx("div",{ref:T,className:`
                ...
                `,style:{backfaceVisibility:"hidden"},children:p&&j.jsx(kA,{planet:p,calculateRealPosition:G,earthRealPosition:ee,onClose:H,showAxialTilt:v,onToggleAxialTilt:N})})]})]}),j.jsxs("main",{className:"flex-1 min-w-0 h-full relative bg-[#000000]",children:[j.jsx(tA,{positions:re,selectedPlanetId:l,onSelectPlanet:W,showOrbits:f,solveKepler:z,speed:n,cameraResetTrigger:h,showAxialTilt:v}),j.jsx(UA,{isPlaying:t,onTogglePlay:()=>e(!t),speed:n,onSpeedChange:i,onResetCamera:K,showOrbits:f,onToggleOrbits:()=>d(!f),mobileBottomOffset:Ie})]})]})},F_=document.getElementById("root");if(!F_)throw new Error("Could not find root element to mount to");const BA=Au.createRoot(F_);BA.render(j.jsx(Xl.StrictMode,{children:j.jsx(zA,{})}));
